...
<div class="btn-group pr-1">
    ...
    <div class="dropdown-menu">
        <a id="button" class="btn btn-primary" href="login.php" role="button">Login</a>
        <br>
        <a id="button" class="btn btn-primary p-0" style="font-size:14px; height:24px;" href="login.php" role="button">Register</a>
        <div class="dropdown-divider"></div>
        <a id="button" class="btn btn-secondary p-0" style="font-size:14px; height:24px;" href="logout.php" role="button">Logout</a>
        <div class="dropdown-divider"></div>
        <span class="m-2" style="font-size:12px;">Please login to loan items</span>
        </div>
</div>
